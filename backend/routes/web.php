...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
 ...
 Route::get('/feedback/inbox',[AdminController::class,'feedback'])->name('feedback'); Route::put('/feedback/{feedback}',[AdminController::class,'updateFeedback'])->name('feedback.update'); Route::delete('/feedback/{feedback}',[AdminController::class,'deleteFeedback'])->name('feedback.delete');
